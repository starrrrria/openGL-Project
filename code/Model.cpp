...
void Model::PickState(){
    pick = 1;
    std::cout << "You pick up " << Name << std::endl;
}
void Model::PutState(int judge){
    if (judge == 1) {
        std::cout << "You put down " << Name << " in the right place" << std::endl;
    }
    else{
        pick = 0;
        std::cout << "You put down " << Name << " in the wrong place" << std::endl;
    }
