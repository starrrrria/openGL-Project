...
void Camera::UpdateCameraPos(){
    ...
    firstPosition.y = 1;
    //std::cout << firstPosition.x << std::endl;
    thirdPosition.x =  firstPosition.x - length * Forward.x;
    thirdPosition.z =  firstPosition.z - length * Forward.z;
    thirdPosition.y =  firstPosition.y;
    //std::cout << firstPosition.x << firstPosition.z << std::endl;
}
